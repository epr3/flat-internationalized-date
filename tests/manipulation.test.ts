...
describe("CalendarDate manipulation", function () {
  describe("add", function () {
    ...
    it("should add months across years", function () {
      const date = new CalendarDate(2020, 9, 1);
    ...
    it("should add months and constrain days", function () {
      const date = new CalendarDate(2020, 8, 31);
    ...
    it("should add days across months", function () {
      const date = new CalendarDate(2020, 9, 20);
    ...
    it("should add days across years", function () {
      const date = new CalendarDate(2020, 12, 20);
    ...
    it("should handle leap years", function () {
      const date = new CalendarDate(2020, 2, 28);
    ...
    it("should handle non-leap years", function () {
      const date = new CalendarDate(2019, 2, 28);
    ...
    it("should add years, months, and days together", function () {
      const date = new CalendarDate(2020, 10, 25);
      expect(date.add({ years: 2, months: 3, days: 10 })).toEqual(
        new CalendarDate(2023, 2, 4)
      );
    });
    ...
    it("should add in BC", function () {
      const date = new CalendarDate("BC", 10, 9, 3);
    ...
    describe("Taiwan calendar", function () {
      ...
      it("should constrain when reaching year 8088", function () {
        const date = new CalendarDate(new TaiwanCalendar(), 8088, 12, 10);
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new TaiwanCalendar(), 8088, 12, 31)
        );
      });
    ...
    describe("Hebrew calendar", function () {
      it("should add months in a non-leap year", function () {
        ...
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new HebrewCalendar(), 5781, 6, 1)
        );

        date = new CalendarDate(new HebrewCalendar(), 5781, 12, 1);
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new HebrewCalendar(), 5782, 1, 1)
        );
      });
      ...
      it("should add months in a leap year", function () {
        ...
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new HebrewCalendar(), 5782, 13, 1)
        );
      });

      it("should add years in a leap year", function () {
        const date = new CalendarDate(new HebrewCalendar(), 5782, 13, 1);
        expect(date.add({ years: 1 })).toEqual(
          new CalendarDate(new HebrewCalendar(), 5783, 12, 1)
        );
      });

      it("should constrain when reaching year 1", function () {
        const date = new CalendarDate(new HebrewCalendar(), 1, 1, 10);
        expect(date.subtract({ months: 1 })).toEqual(
          new CalendarDate(new HebrewCalendar(), 1, 1, 1)
        );
      });

      it("should constrain when reaching year 9999", function () {
        const date = new CalendarDate(new HebrewCalendar(), 9999, 12, 10);
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new HebrewCalendar(), 9999, 12, 29)
        );
      });
    });
    ...
    describe("IndianCalendar", function () {
      it("should constrain when reaching year 1", function () {
        const date = new CalendarDate(new IndianCalendar(), 1, 1, 10);
        expect(date.subtract({ months: 1 })).toEqual(
          new CalendarDate(new IndianCalendar(), 1, 1, 1)
        );
      });

      it("should constrain when reaching year 9919", function () {
        const date = new CalendarDate(new IndianCalendar(), 9919, 12, 10);
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new IndianCalendar(), 9919, 12, 31)
        );
      });
    });
    ...
    describe("PersianCalendar", function () {
      it("should constrain when reaching year 1", function () {
        const date = new CalendarDate(new PersianCalendar(), 1, 1, 10);
        expect(date.subtract({ months: 1 })).toEqual(
      ...
      it("should constrain when reaching year 9377", function () {
        const date = new CalendarDate(new PersianCalendar(), 9377, 12, 10);
        expect(date.add({ months: 1 })).toEqual(
    ...
    describe("BuddhistCalendar", function () {
      it("should constrain when reaching year 1", function () {
        const date = new CalendarDate(new BuddhistCalendar(), 1, 1, 12);
        expect(date.subtract({ months: 1 })).toEqual(
      ...
      it("should constrain when reaching year 9999", function () {
        const date = new CalendarDate(new BuddhistCalendar(), 9999, 12, 10);
        expect(date.add({ months: 1 })).toEqual(
    ...
    describe("CopticCalendar", function () {
      it("should rebalance era when subtracting", function () {
        const date = new CalendarDate(new CopticCalendar(), 1, 1, 12);
        expect(date.subtract({ months: 1 })).toEqual(
      ...
      it("should rebalance era when adding", function () {
        const date = new CalendarDate(new CopticCalendar(), "BCE", 1, 13, 5);
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new CopticCalendar(), 1, 1, 5)
        );
      });

      it("should constrain when reaching year 9715 CE", function () {
        const date = new CalendarDate(new CopticCalendar(), 9715, 13, 2);
        expect(date.add({ months: 1 })).toEqual(
          new CalendarDate(new CopticCalendar(), 9715, 13, 6)
        );
      });

      it("should constrain when reaching year 9999 BCE", function () {
        const date = new CalendarDate(new CopticCalendar(), "BCE", 9999, 1, 5);
        expect(date.subtract({ months: 1 })).toEqual(
    ...
    describe("EthiopicCalendar", function () {
      it("should constrain when reaching year 9991 AM", function () {
        const date = new CalendarDate(new EthiopicCalendar(), 9991, 13, 2);
        expect(date.add({ months: 1 })).toEqual(
    ...
    describe("IslamicCivilCalendar", function () {
      it("should constrain when reaching year 9995", function () {
        const date = new CalendarDate(new IslamicCivilCalendar(), 9995, 12, 2);
        expect(date.add({ months: 1 })).toEqual(
  ...
  describe("subtract", function () {
    ...
    it("should subtract months", function () {
      const date = new CalendarDate(2020, 6, 1);
      expect(date.subtract({ months: 5 })).toEqual(
        new CalendarDate(2020, 1, 1)
      );
    });

    it("should subtract months across years", function () {
      const date = new CalendarDate(2021, 2, 1);
      expect(date.subtract({ months: 5 })).toEqual(
    ...
    it("should subtract months across multiple years", function () {
      const date = new CalendarDate(2022, 2, 1);
      expect(date.subtract({ months: 17 })).toEqual(
        new CalendarDate(2020, 9, 1)
      );
    });

    it("should subtract months and constrain days", function () {
      const date = new CalendarDate(2020, 10, 31);
      expect(date.subtract({ months: 1 })).toEqual(
        new CalendarDate(2020, 9, 30)
      );
    });

    it("should subtract days", function () {
      const date = new CalendarDate(2020, 9, 6);
      expect(date.subtract({ days: 5 })).toEqual(new CalendarDate(2020, 9, 1));
    });

    it("should subtract days across months", function () {
      const date = new CalendarDate(2020, 10, 5);
      expect(date.subtract({ days: 15 })).toEqual(
        new CalendarDate(2020, 9, 20)
      );
    });

    it("should subtract days across multiple months", function () {
      const date = new CalendarDate(2020, 11, 5);
      expect(date.subtract({ days: 46 })).toEqual(
        new CalendarDate(2020, 9, 20)
      );
    });

    it("should subtract days across years", function () {
      const date = new CalendarDate(2021, 1, 4);
      expect(date.subtract({ days: 15 })).toEqual(
        new CalendarDate(2020, 12, 20)
      );
    });

    it("should subtract days across multiple years", function () {
      const date = new CalendarDate(2022, 1, 4);
      expect(date.subtract({ days: 380 })).toEqual(
        new CalendarDate(2020, 12, 20)
      );
    });
    ...
    it("should subtract weeks", function () {
      const date = new CalendarDate(2020, 10, 6);
    ...
    it("should subtract in BC", function () {
      const date = new CalendarDate("BC", 1, 9, 3);
      expect(date.subtract({ years: 1 })).toEqual(
        new CalendarDate("BC", 2, 9, 3)
      );
    });
    ...
    it("should subtract between AD and BC", function () {
      ...
      expect(date.subtract({ years: 1 })).toEqual(
        new CalendarDate("BC", 1, 9, 3)
      );

      date = new CalendarDate(10, 9, 3);
      expect(date.subtract({ years: 20 })).toEqual(
        new CalendarDate("BC", 11, 9, 3)
      );
    });
    ...
    describe("Japanese calendar", function () {
      ...
      it("should subtract days and rebalance era", function () {
        const date = new CalendarDate(new JapaneseCalendar(), "reiwa", 1, 5, 1);
    ...
    describe("Taiwan calendar", function () {
      it("should subtract years and rebalance era", function () {
        const date = new CalendarDate(new TaiwanCalendar(), "minguo", 1, 4, 30);
        expect(date.subtract({ years: 1 })).toEqual(
      ...
      it("should subtract months and rebalance era", function () {
        const date = new CalendarDate(new TaiwanCalendar(), "minguo", 1, 1, 30);
        expect(date.subtract({ months: 1 })).toEqual(
      ...
      it("should subtract days and rebalance era", function () {
        const date = new CalendarDate(new TaiwanCalendar(), "minguo", 1, 1, 1);
        expect(date.subtract({ days: 1 })).toEqual(
  ...
  describe("set", function () {
    it("should set year", function () {
      const date = new CalendarDate(2020, 2, 3);
    ...
    it("should constrain day", function () {
      const date = new CalendarDate(2020, 9, 3);
  ...
  describe("cycle", function () {
    ...
    describe("year", function () {
      it("should cycle the year", function () {
        ...
        date = new CalendarDate(10, 9, 3);
        expect(date.cycle("year", -20)).toEqual(
          new CalendarDate("BC", 11, 9, 3)
        );
      ...
      it("should cycle the year with rounding", function () {
        const date = new CalendarDate(2019, 9, 3);
        expect(date.cycle("year", 5, { round: true })).toEqual(
          new CalendarDate(2020, 9, 3)
        );
        expect(date.cycle("year", -5, { round: true })).toEqual(
          new CalendarDate(2015, 9, 3)
        );
      });

      it("should constrain the day on leap years", function () {
        const date = new CalendarDate(2020, 2, 29);
    ...
    describe("month", function () {
      ...
      it("should cycle the month with rounding", function () {
        const date = new CalendarDate(2020, 8, 3);
        expect(date.cycle("month", 5, { round: true })).toEqual(
          new CalendarDate(2020, 10, 3)
        );
        expect(date.cycle("month", -5, { round: true })).toEqual(
    ...
    describe("day", function () {
      ...
      it("should cycle the day with rounding", function () {
        const date = new CalendarDate(2020, 8, 3);
        expect(date.cycle("day", 5, { round: true })).toEqual(
          new CalendarDate(2020, 8, 5)
        );
        expect(date.cycle("day", -5, { round: true })).toEqual(
          new CalendarDate(2020, 8, 1)
        );
      });
...
describe("CalendarDateTime manipulation", function () {
  describe("add", function () {
    ...
    `("should add $Unit", ({ Unit, Expected }) => {
      const date = new CalendarDateTime(2020, 1, 1, 0, 0, 0, 0);
  ...
  describe("subtract", function () {
    ...
    `("should subtract $Unit", ({ Unit, Expected }) => {
      const date = new CalendarDateTime(2020, 1, 1, 5, 5, 5, 5);
...
describe("ZonedDateTime manipulation", function () {
  describe("add", function () {
    ...
    `("should add $Unit", ({ Unit, Expected }) => {
      const date = new ZonedDateTime(2020, 1, 1, "UTC", 0, 0, 0, 0, 0);
      expect(date.add({ [`${Unit}`]: 5 })).toEqual(Expected);
    });
  });
  ...
  describe("subtract", function () {
    ...
    `("should subtract $Unit", ({ Unit, Expected }) => {
      const date = new ZonedDateTime(2020, 1, 1, "UTC", 0, 5, 5, 5, 5);
      expect(date.subtract({ [`${Unit}`]: 5 })).toEqual(Expected);
    });
  });
});
